      ...
      <div className=' padding-container max-container w-full pb-24'>
       ...
       <div className='flex flex-wrap justify-between gap-5 lg:gap-8'>
         ...
         <p className='regular-16 text-gray-30 xl:max-w-[520px]'>
           ...
           we already support offline maps when there is no internt connection in the field. Invte your friends, relatives and friends 
           to have fun through the wilderness through the valley and reach the top of the mountain.
        </p>  
       </div>
      </div>
